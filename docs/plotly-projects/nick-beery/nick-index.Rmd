...
An additional thing that I would like to do with this data is show how total nominal GDP changed over this time period. I tried to stick to just one visualization so I could not do that. You would see that the nominal GDP of the USA has risen exponentially over the last 90 years or so.
